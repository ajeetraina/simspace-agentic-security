...
<svg viewBox="0 0 1086 52" width="100%" role="img" aria-label="Supply-chain progress: done Agent build, done SBOM · VEX · SLSA, done Hardened base, current Verify &amp; Gate, Agentic MCP, Build Sandbox">
