...
## Slide 57 - Sandboxes (experimental): run agents in isolation rather than on your bare ma...
...
## Slide 58 - Sandbox architecture: on the host machine, the agent container runs inside a ...
...
## Slide 59 - The Sandbox TUI: Docker Sandboxes live view - sandboxes on the left (claude-d...
...
## Slide 60 - Managing credentials: always prefer stored secrets over env vars (keychain en...
...
## Slide 61 - Protecting MCP: tools are how agents act on the world - govern which servers ...
...
## Slide 62 - The agent talks to one gateway, never to servers directly: the sandboxed agen...
...
## Slide 63 - Point it at a real gateway: local gateway http://localhost:8811 (Compose or D...
...
## Slide 64 - Author once in Docker Hub, enforce around the sandbox and at the gateway: Doc...
...
## Slide 65 - The server lifecycle - five commands: sbx mcp add to register, sbx mcp ls/ins...
...
## Slide 66 - Default-deny allow-list over (server, tool), authored in Cedar: a permit poli...
...
## Slide 71 - The journey, checkpoint 4 of 4: Lab 4 done, DEVELOP and INVOKE green, both sa...
